 ...
 * @generated
 */
public class QR1Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case QR1Package.DATE_DATA: {
			DateData dateData = (DateData) theEObject;
			T result = caseDateData(dateData);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QR1Package.ENCRYPTED_QR: {
			EncryptedQR encryptedQR = (EncryptedQR) theEObject;
			T result = caseEncryptedQR(encryptedQR);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case QR1Package.DECRYPTED_QR: {
			DecryptedQR decryptedQR = (DecryptedQR) theEObject;
			T result = caseDecryptedQR(decryptedQR);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Date Data</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Date Data</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDateData(DateData object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Encrypted QR</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Encrypted QR</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEncryptedQR(EncryptedQR object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Decrypted QR</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Decrypted QR</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDecryptedQR(DecryptedQR object) {
		return null;
	}
